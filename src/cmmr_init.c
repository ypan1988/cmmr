...
/* .Call calls */
extern SEXP _cmmr_mcbd_estimation(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
	  {"_cmmr_mcbd_estimation", (DL_FUNC) &_cmmr_mcbd_estimation, 13},
